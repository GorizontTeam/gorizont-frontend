...
{#if checked}
    <!-- GRID -->
    <div class="grid grid-1 container">
        <!-- GRID COLUMN -->
        <div class="grid-column">
            <!-- WIDGET BOX -->
            <div class="widget-box">
                <!-- WIDGET BOX TITLE -->
                <h1 class="widget-box-title">Задание проверено</h1>
                <!-- /WIDGET BOX TITLE -->
            </div>
            <!-- /WIDGET BOX -->
        </div>
    ...
    <div class="grid grid-1 container">
        ...
        <div class="grid-column">
            ...
            <div class="stream-box big">
                <!-- STREAM BOX VIDEO -->
                <div class="stream-box-video" style="padding-top: 500px">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/-tTVJ3UIGUA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <!-- /STREAM BOX VIDEO -->
            ...
            <div class="widget-box">
                ...
                <!-- WIDGET BOX CONTENT -->
                <a href="/file.rtf" download style="text-decoration: underline">file.rtf</a>
                <!-- /WIDGET BOX CONTENT -->
            </div>
            <!-- /WIDGET BOX -->
            ...
            <div class="widget-box">
                <!-- WIDGET BOX TITLE -->
                <p class="widget-box-title">Оценка:</p>
                <!-- /WIDGET BOX TITLE -->

                <select class="mt-3" name="" id="" style="padding: 5px 10px 5px 10px">
                ...
                <!-- WIDGET BOX TITLE -->
                <p class="widget-box-title mt-5">Статус:</p>
                <!-- /WIDGET BOX TITLE -->

                <select class="mt-3" name="" id="" style="padding: 5px 10px 5px 10px">
                    <option value="1">на доработку</option>
                    <option value="2">пройдено</option>
                    <option value="3" selected>ожидает проверки</option>
                </select>
            </div>
            <!-- /WIDGET BOX -->

            <div>
                <button on:click={() => checked = true} class="button" style="padding-right: 20px; padding-left: 20px; width: fit-content">
                    Проверить
                </button>
            </div>
