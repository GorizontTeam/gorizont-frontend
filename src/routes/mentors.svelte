...
<div class="">
    ...
    <div class="section-banner mb-5">
        ...
        <p class="section-banner-title">Наставники</p>
        <!-- /SECTION BANNER TITLE -->
    </div>
    <!-- /SECTION BANNER -->
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px;">
        ...
        <div class="user-preview">
            <!-- USER PREVIEW COVER -->
            <figure class="user-preview-cover liquid" style="background: url(&quot;img/cover/54.jpg&quot;) center center / cover no-repeat;">
            ...
            <div class="user-preview-info">
                ...
                <div id="user-preview-stats-slides-01" class="user-preview-stats-slides">
                    ...
                    <div class="user-preview-stats-slide">
                        <!-- USER STATS -->
                        <div class="user-stats" style="justify-content: initial">
                            <!-- USER STAT -->
                            <div class="user-stat">
                                <!-- USER STAT TITLE -->
