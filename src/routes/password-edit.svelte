<!-- CONTENT GRID -->
<div class="content-grid" style="transform: translate(220px, 0px); transition: transform 0.4s ease-in-out 0s; margin-top: -80px">
    <!-- SECTION BANNER -->
                ...
                <div class="sidebar-menu round-borders">
                    ...
                    <div class="sidebar-menu-item">
                        ...
                        <div class="sidebar-menu-body accordion-content-linked accordion-open">
                            ...
                            <!-- SIDEBAR MENU LINK -->
                            <a class="sidebar-menu-link active" href="hub-account-password.html">Change Password</a>
                            <!-- /SIDEBAR MENU LINK -->
