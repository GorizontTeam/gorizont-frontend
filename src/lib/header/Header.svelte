<!-- NAVIGATION WIDGET -->
<nav id="navigation-widget-small" class="navigation-widget navigation-widget-desktop closed sidebar left delayed hidden">
	<!-- USER AVATAR -->
...
<header class="header">
	...
	<div class="header-actions search-bar">
		...
		<!-- DROPDOWN BOX -->
		<div class="dropdown-box padding-bottom-small header-search-dropdown" style="position: absolute; z-index: 9999; top: 57px; left: 0px; opacity: 1; visibility: hidden; transform: translate(0px, 0px); transition: transform 0.4s ease-in-out 0s, opacity 0.4s ease-in-out 0s, visibility 0.4s ease-in-out 0s;">
	...
	<div class="header-actions">
		...
		<div class="action-list dark">
			...
			<div class="action-list-item-wrap">
				...
				<!-- DROPDOWN BOX -->
				<div class="dropdown-box no-padding-bottom header-dropdown" style="position: absolute; z-index: 9999; top: 64px; right: 6px; opacity: 1; visibility: hidden; transform: translate(0px, 0px); transition: transform 0.4s ease-in-out 0s, opacity 0.4s ease-in-out 0s, visibility 0.4s ease-in-out 0s;">
					<!-- DROPDOWN BOX HEADER -->
			...
			<div class="action-list-item-wrap">
				...
				<!-- DROPDOWN BOX -->
				<div class="dropdown-box header-dropdown" style="position: absolute; z-index: 9999; top: 64px; right: 6px; opacity: 1; visibility: hidden; transform: translate(0px, 0px); transition: transform 0.4s ease-in-out 0s, opacity 0.4s ease-in-out 0s, visibility 0.4s ease-in-out 0s;">
					<!-- DROPDOWN BOX HEADER -->
					<div class="dropdown-box-header">
						<!-- DROPDOWN BOX HEADER TITLE -->
		...
		<div class="action-item-wrap">
			...
			<!-- DROPDOWN NAVIGATION -->
			<div class="dropdown-navigation header-settings-dropdown" style="position: absolute; z-index: 9999; top: 64px; right: 22px; opacity: 1; visibility: hidden; transform: translate(0px, 0px); transition: transform 0.4s ease-in-out 0s, opacity 0.4s ease-in-out 0s, visibility 0.4s ease-in-out 0s;">
